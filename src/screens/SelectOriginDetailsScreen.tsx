...
type SelectOriginDetailsScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  'SelectOriginDetails'
>;

// List of countries with their default languages
const countries = [
  ...
  { id: '7', name: 'Canada', language: 'English' },
  { id: '8', name: 'Australia', language: 'English' },
];
...
const SelectOriginDetailsScreen = () => {
  const navigation = useNavigation<SelectOriginDetailsScreenNavigationProp>();
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Select Origin Details</Text>
        <View style={{ width: 28 }} />
      </View>
      ...
      <View style={styles.contentContainer}>
        <Text style={styles.sectionTitle}>Origin Country and Language</Text>
        
        <Text style={styles.subtitle}>
          Select the country and language of your Passport
        </Text>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <TouchableOpacity
                  ...
                  onPress={() => handleCountrySelection(item.name)}
                >
      ...
      <View style={styles.bottomContainer}>
        <TouchableOpacity 
          style={[
            styles.nextButton,
            (!country || !language) && styles.nextButtonDisabled
          ]}
...
export default SelectOriginDetailsScreen; 
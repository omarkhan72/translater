...
type ReviewTranslatedDataScreenNavigationProp = StackNavigationProp<RootStackParamList, 'ReviewTranslatedData'>;
...
const ReviewTranslatedDataScreen = () => {
  const navigation = useNavigation<ReviewTranslatedDataScreenNavigationProp>();
  const [isChecked, setIsChecked] = useState(false);
  
  // Form state with translated content
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Review Translated Document</Text>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.descriptionContainer}>
            <Text style={styles.descriptionText}>
              Please review your translated document data below. Edit any information if needed.
            </Text>
          ...
          <View style={styles.infoBox}>
            <Icon name="globe-outline" size={20} color="#4D98FF" style={styles.infoBoxIcon} />
            <Text style={styles.infoBoxText}>
              This is your document translated to the target language
            </Text>
          </View>
          ...
          <View style={styles.checkboxContainer}>
            ...
            <Text style={styles.checkboxText}>
              I confirm the translated information is accurate and complete
            </Text>
          </View>
...
export default ReviewTranslatedDataScreen; 